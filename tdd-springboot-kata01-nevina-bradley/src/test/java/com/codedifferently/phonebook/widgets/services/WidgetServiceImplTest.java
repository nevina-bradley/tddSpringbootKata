...
public class WidgetServiceImplTest {
    ...
    public void getWidgetByIdTestSuccess() throws WidgetException {
    ...
    public void getWidgetByIdTestFailed() {
        ...
        Assertions.assertThrows(WidgetException.class, () -> {
    ...
    public void updateWidgetTestSuccess() throws WidgetException {
        List<WidgetPart> parts = new ArrayList<>();
        parts.add(new WidgetPart("Part 1"));
        parts.add(new WidgetPart("Part 2"));
    ...
    public void deleteWidgetTestSuccess() throws WidgetException {
        BDDMockito.doReturn(Optional.of(mockResponseWidget1)).when(mockWidgetRepo).findById(1);
